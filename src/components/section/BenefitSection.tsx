    ...
    return (
        <SectionContainer className='h-full mt-20 sm:-mt-0 sm:h-[700px]' id='benefits' container>
            <div className='flex items-center justify-center sm:max-w-[1300px] sm:mx-auto sm:gap-16 h-full relative'>
                <Image src={"./images/benefits.svg"} alt='benefit' width={550} height={550} draggable={false} className='w-[650px] sm:w-[550px] hidden sm:block' />
                <div className='h-auto -mt-16 sm:-mt-0'>
                    <h2 className='text-[32px] sm:text-[40px] text-center sm:text-left font-bold z-50'>Why Choose <span className='text-[#5B86E5]'>Us?</span></h2>
