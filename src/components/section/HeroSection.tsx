...
const HeroSection = () => {
    return (
        <SectionContainer className="h-screen max-h-[900px] flex flex-col items-center justify-center *:text-zinc-50 bg-[url('/images/backgrounds/hero.svg')] bg-cover bg-center">
            <div className='flex flex-col items-center gap-2 -mt-16 sm:-mt-0'>
                <div className='flex items-center sm:flex-row flex-col gap-3'>
                    ...
                    <Link href="/about" className="flex gap-2 items-center text-[16px] tracking-[0.25px] hover:opacity-80">Discover all the benefits <ArrowRight size={17} /></Link>
                </div>
