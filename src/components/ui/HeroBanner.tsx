...
const HeroBanner = () => {
    return (
        <div className="bg-[url('/images/backgrounds/hero-banner.png')] bg-cover bg-center h-[303px] flex flex-col items-center justify-center text-white text-4xl font-bold mt-44 px-3">
